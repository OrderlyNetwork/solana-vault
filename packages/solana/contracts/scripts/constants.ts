...
export const MAIN_BROKERS = [
    'woofi_dex', // not support on mainnet
    'root',
    'orderly',
    'woofi_pro',
    'busywhale',
    ...
    'emdx_dex',
    'logx',
    'rkqa_dex', // not support on mainnet
    'prime_protocol',
    'bitoro_network',
    'coolwallet',
    'quick_perps',
    ...
    'galar_fin',
    'what_exchange',
    'ibx', // deposit broker pda not initialized
    'unibot',
    'ascendex',
    'sharpe_ai',
    'panda_terminal',
    ...
    'alphanaut',
    'rage_trade',
    'zk_automate', // not support on mainnet
    'flash_x',
    'pinde',
    'ox_markets',
    'funl_ai',
    ...
    'involio',
    'hyperx',
    'ranger', // deposit broker pda not initialized
    'luma',
    'hyperai',
    'trading_strategy',
    'lolol', // deposit broker pda not initialized
    'bgsc',
    'apolo_pay',
    'ninco_fi',
    'shitzu',
    ...
    'million',
    'veterans_crew',
    'otter_lee', // not support on mainnet
    'foxify',
    'zenthryx',
    'perpsdao',
    'amped',
