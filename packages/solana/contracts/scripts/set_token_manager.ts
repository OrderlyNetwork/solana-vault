...
async function setTokenManagerRole() {
    ...
    const tokenManager = wallet.publicKey;
    ...
    const ixSetManagerRole = await OAppProgram.methods.setManagerRole(setManagerRoleParams).accounts(setManagerRoleAccounts).instruction();
